...
void CBattleSoccerManager::SetBattleTeamMaster(int ground, int team, const char* szname, GUILD_INFO* lpGuild)
{
...
const char* CBattleSoccerManager::GetBattleTeamName(int ground, int team)
{
	if (BATTLE_SOCCER_GROUND_RANGE(ground) == false)
	{
		return NULL;
