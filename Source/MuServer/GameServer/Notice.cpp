...
void CNotice::Load(const char* path)
{
...
void CNotice::GCNoticeSend(int aIndex, BYTE type, const char* message, ...)
{
	char buff[256] = { 0 };
...
void CNotice::GCNoticeSendToAll(BYTE type, const char* message, ...)
{
	char buff[256] = { 0 };
