...
{
#ifndef _WIN32
	const char* envPath = std::getenv("MU_DATA_PATH");
	if (envPath && envPath[0] != '\0')
	{
		gPath.SetMainPath(envPath);
	}
	else if (access("/opt/mu/Data", F_OK) == 0)
	{
		gPath.SetMainPath("/opt/mu/Data/");
	}
	else
	{
...
void CServerInfo::ReadMapInfo()
{
	...
	{
		wsprintf(temp, "Terrain\\Terrain%d.att", (n + 1));
...
void CServerInfo::ReadStartupInfo(const char* section, const char* path)
{
...
void CServerInfo::ReadChaosMixInfo(const char* section, const char* path)
{
...
void CServerInfo::ReadCharacterInfo(const char* section, const char* path)
{
...
void CServerInfo::ReadCommandInfo(const char* section, const char* path)
{
...
void CServerInfo::ReadEventInfo(const char* section, const char* path)
{
...
void CServerInfo::ReadHackInfo(const char* section, const char* path)
{
...
void CServerInfo::ReadSkillInfo(const char* section, const char* path)
{
