...
public:
	...
	void ReadChaosMixInfo(const char* section, const char* path);

	void ReadCharacterInfo(const char* section, const char* path);

	void ReadCommandInfo(const char* section, const char* path);

	void ReadCommonInfo(const char* section, const char* path);

	void ReadEventInfo(const char* section, const char* path);

	void ReadHackInfo(const char* section, const char* path);

	void ReadSkillInfo(const char* section, const char* path);
