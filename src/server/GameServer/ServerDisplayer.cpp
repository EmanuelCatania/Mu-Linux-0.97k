...
void CServerDisplayer::Init(HWND)
{
	gLog.AddLog((gServerInfo.m_WriteGeneralLog != 0), "LOG");
	gLog.AddLog((gServerInfo.m_WriteChatLog != 0), "LOG_CHAT");
	gLog.AddLog((gServerInfo.m_WriteCommandLog != 0), "LOG_COMMAND");
	gLog.AddLog((gServerInfo.m_WriteTradeLog != 0), "LOG_TRADE");
	gLog.AddLog((gServerInfo.m_WriteConnectLog != 0), "LOG_CONNECT");
	gLog.AddLog((gServerInfo.m_WriteHackLog != 0), "LOG_HACK");
	gLog.AddLog((gServerInfo.m_WriteChaosMixLog != 0), "LOG_CHAOS_MIX");
}
