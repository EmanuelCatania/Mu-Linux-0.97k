...
void CBattleGround::SetTeamMaster(int n, const char* szId)
{
	if (n == 0)
	{
...
void CBattleGround::SetTeamName(int n, const char* szName)
{
	if (n == 0)
	{
...
const char* CBattleGround::GetTeamName(int n)
{
	if (n == 0)
	{
