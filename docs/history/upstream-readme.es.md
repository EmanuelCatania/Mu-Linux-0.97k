> **Historical archive — not normative.**
> This upstream snapshot is retained for provenance only. Commands, versions,
> examples, credentials, and architectural decisions may be obsolete. Use the
> current code and documentation as the source of truth.
# Mu Linux 97K
